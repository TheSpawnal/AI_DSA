# Findings risky neighbourhoods.

# The water management department has a network of surveillance sensors at every corner of the Amsterdam sewage system. 
# Every sensor reports the level of chemical waste in the water. Each day the
# sensors are queried for an updated measurement roughly by neighbourhood. 
# Therefore, the measurements from sensors that are in close proximity to each other are 
# initially stored on consecutive array locations.
